...
export class DateTimeHelper {
  ...
  /**
     ...
     * @returns 格式化后的时间字符串
     */
  static formatFromSecond(timeStamp: number, formateString?: DateTimeFormatterEnum | string): string {
  ...
  /**
     ...
     * @returns 格式化后的时间字符串
     */
  static formatFromMilliSecond(timeStamp: number, formateString?: DateTimeFormatterEnum | string): string {
  ...
  /**
     ...
     * @returns 格式化后的时间字符串
     */
  static formatFromDate(date: Date | string, formateString?: DateTimeFormatterEnum | string): string {
    if (!formateString) {
